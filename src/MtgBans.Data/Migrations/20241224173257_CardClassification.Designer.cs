...
namespace MtgBans.Data.Migrations
{
    ...
    [Migration("20241224173257_CardClassification")]
    partial class CardClassification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MtgBans.Data.Entities.Card", b =>
                {
                    ...
                    b.HasIndex("ClassificationId")
                        .HasDatabaseName("ix_cards_classification_id");
            ...
            modelBuilder.Entity("MtgBans.Data.Entities.Card", b =>
                {
                    b.HasOne("MtgBans.Data.Entities.Classification", "Classification")
                        .WithMany()
                        .HasForeignKey("ClassificationId")
                        .HasConstraintName("fk_cards_classification_classification_id");
